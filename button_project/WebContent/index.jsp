            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">모니터링 대시보드</h1>
                        <h4><form>
                        모니터링 대상 선택  :  <select>
                            <option>김철수</option>
                            <option>박철수</option>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">(6월 18일) 오후 7시 12분 경
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">좋음</div>
                                                </div>
                                                <div class="col">
   ...
   <!-- Pie Chart -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">설문 응답 결과 (최근 4개 항목)</h6>
                                </div>
                                <div class="card-body">

                                    <sup><a href="#" class="btn btn-success btn-circle btn-sm">
                                        <i class="fas fa-check"></i>
                                    </a></sup><h5 style="display: inline;">&nbsp; 응답 </h5>&nbsp;&nbsp;
                                    <sup><a href="#" class="btn btn-warning btn-circle btn-sm">
                                            <i class="fas fa-exclamation-triangle"></i>
                                    </a></sup><h5 style="display: inline;">&nbsp; 보류 </h5>

                                    <p>
                                    <h3 style="display: inline;">(2022년 6월 24일 오후 1시) "식사 하셨나요?"&nbsp;</h3>
                                    <sup><a href="#" class="btn btn-success btn-circle btn-sm">
                                            <i class="fas fa-check"></i>
                                        </a></sup></p>
                                    <p>
                                    <h3 style="display: inline;">(2022년 6월 23일 오후 1시) "식사 하셨나요?"&nbsp;</h3>
                                    <sup><a href="#" class="btn btn-success btn-circle btn-sm">
                                            <i class="fas fa-check"></i>
                                        </a></sup></p>
                                    <p>
                                    <h3 style="display: inline;">(2022년 6월 22일 오후 1시) "식사 하셨나요?"&nbsp;</h3>
                                    <sup><a href="#" class="btn btn-warning btn-circle btn-sm">
                                            <i class="fas fa-exclamation-triangle"></i>
                                        </a></sup></p>
                                    <p>
                                    <h3 style="display: inline;">(2022년 6월 21일 오후 1시) "식사 하셨나요?"&nbsp;</h3>
                                    <sup><a href="#" class="btn btn-warning btn-circle btn-sm">
                                            <i class="fas fa-exclamation-triangle"></i>
                                        </a></sup></p>
                                    ...
                                    <a href="#" class="btn btn-light btn-icon-split">
                                        ...
                                        <span class="text">질문 설정 및 등록</span>
                                    </a>
