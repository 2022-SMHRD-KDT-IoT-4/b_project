...
success : function(result) {
   ...
   // 조건
   // 1. 아이디==세션버튼아이디  (가데이터='25')
   // 2. 월별 == 지금 월이고
   // 3. result.feeds.created_at = 질문 테이블의 질문 시간
   // 인 field6 값 받아오기
   ...
   var myPieChart = new Chart(ctx, {
      type : 'doughnut',
      data : {
         labels : [ "안녕히 주무셨어요? ", "아침식사는 하셨나요?" , "아침 약은 드셨나요?" , "지금 아픈 데가 있으신가요?", "점심식사는 하셨나요","오늘 운동은 하셨나요?","피곤하진 않으세요?","오늘 친구는 만나셨나요?","저녁식사는 하셨나요?","저녁 약은 드셨나요?","주무실 준비는 하셨나요?","무응답"],
         datasets : [ {
